...
public:
    ...
    PerspectiveCamera(const AnimatedTransform<camera_s, world_s> &cam2world,
        const mfloat<length_d> screenWindow[4], 
        const mfloat<time_d> &sopen, const mfloat<time_d> &sclose, 
        const mfloat<length_d> &lensr, const mfloat<length_d> &focald, float fov, Film *film);
