...
typedef dimension_division<unit_d,length_d>::type invlength_d;
...
typedef dimension_product<area_d,length_d>::type volume_d;
...
typedef dimension_division<invsolidangle_d,area_d>::type invsolidanglearea_d;

typedef dimension_division<radiance_d, length_d>::type radiancediff_d;
