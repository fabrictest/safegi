...
public:
    ...
    Spectrum<radiance_d> Li(const Scene *scene, const RayDifferential<world_s> &ray,
        const Sample *sample, RNG &rng, MemoryArena &arena,
        Intersection *isect = NULL, Spectrum<rho_d> *T = NULL) const;
    Spectrum<rho_d> Transmittance(const Scene *scene, const RayDifferential<world_s> &ray,
